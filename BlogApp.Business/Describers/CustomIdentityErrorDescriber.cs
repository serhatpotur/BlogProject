...
namespace BlogApp.Business.Describers
{
    public class CustomIdentityErrorDescriber : IdentityErrorDescriber
    {
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChars)
        {
            return new IdentityError { Code = "PasswordRequiresUniqueChars", Description = $"Parolada en az {uniqueChars} farklı karakter kullanılmalıdır." };
        }
